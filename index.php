...
<body>
    <div class="container" style="width:60%;">
        <h2 align="center"> Creating on Online Shopping Cart in PHP and Mysql</h2>
        <?php 
    ...
    if(!empty($_SESSION["cart"])) 
    {
        ...
        <td><a href="shop.php?action=delete&id=<?php echo $values["product_id"];?>"><span class="text-danger"></span></a></td>
        </tr>
        <?php 
